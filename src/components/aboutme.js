      ...
      <div>
        ...
        <Cell className="aboutme-right-col" col={8}>
          ...
          <article className="aboutme-post">
            <h5>Intro</h5>
            <p>My name is Artem. I am studying in the third course at Nizhny Novgorod State Technical University.</p>
            <p>I have been interested in web technologies since I graduated my school</p>
          </article>
